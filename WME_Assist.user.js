        ...
        var rules_UA = function () {
            ...
            return rules_basicCommon().concat([
                ...
                new Rule('Fix status', function (text) {
                    var streetReg = /вул\./i;
                    var statusReg = /(?: |^)(просп\.|б-р|мкрн\.|наб\.|пл\.|пров\.|квартал|тракт|узвіз|[РНТМ]-[0-9]+|[EОС][0-9]+|міст|в\'їзд|виїзд|въізд|розворот|трамвай|залізниця|шосе|дорог[аи]|майдан|проїзд|заїзд|тупик|до |на |> |шлях|алея|станція|завулок|квартал)(?: |$)/i;
